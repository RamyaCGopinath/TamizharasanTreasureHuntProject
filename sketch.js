...
function draw(){
 ...
 //    }  line 99 
 // after closing curly bracket in line 99, the player detects touch at the beginning and not at the end
...
function Touch(){
 // if(touches.length > 0 && player.y  >= height-120) {
    if(touches.length > 0 ) {
       console.log(touches);
       // touches=[ [x1,y1], [x2,y2], [x3,y3]    ]  // if not made empty
       // touches = [ [x1,y1]  ]  // made empty // new x and y position
       player.x = touches[0][0];
       touches = [];
    }
}
